    ...
    bg-gradient-to-b from-black to-gray-800 p-4 text-white">
        <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
            <div className="pb-8">
                ...
                border-gray-500">
                    Contact</p>
                <p className="py-6">Kindly submit the form below if you would like to get in touch</p>
            </div>
            <div className="flex justify-center items-center ">
                <form action="https://getform.io/f/d45a9f7f-fad5-47e3-80cd-6ca789d06349" method="POST" 
                className="flex flex-col w-full md:w-1/2">
                    ...
                    className="p-2
                     bg-transparent border-2 rounded-md
                      ...
                      placeholder="Write in here your message"
                      ></textarea>
